...
-- Thời gian bảo trì kết thúc (18:00, ngày 11/03 năm nay, giờ Việt Nam)
...
local function getRemainingTime()
    ...
    if remaining <= 0 then
        ...
        return string.format("Bảo trì sẽ kết thúc sau: %d ngày %02d giờ %02d phút %02d giây", days, hours, minutes, seconds)
    end
end
